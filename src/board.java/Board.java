...
public class Board extends JPanel implements ActionListener {
    ...
    private void loadImages() {
        ImageIcon iid = new ImageIcon(Objects.requireNonNull(getClass().getResource("/dot.png")));

//        ImageIcon iid = new ImageIcon("src/resources/dot.png");
        ball = iid.getImage();

        ImageIcon iia = new ImageIcon(Objects.requireNonNull(getClass().getResource("/apple.png")));

//        ImageIcon iia = new ImageIcon("src/resources/apple.png");
        apple = iia.getImage();

        ImageIcon iih = new ImageIcon(Objects.requireNonNull(getClass().getResource("/head.png")));
